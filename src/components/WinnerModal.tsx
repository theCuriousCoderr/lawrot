...
function WinnerModal({ playAgain, quit, winner }) {
  ...
  return (
    <motion.div
      initial={{ scale: 0.5, borderRadius: 40 }}
    ...
    >
      <motion.div  initial={{ y: 200 }} animate={{ y: 0 }} className="relative flex gap-20 flex-col items-center justify-center">
        <div className="">
        ...
        <div className="flex gap-20">
          <div>
            <button
              onClick={playAgain}
              className="w-32 py-1 rounded-md bg-[#EAD70C] font-medium"
            >
              Play Again
            </button>
          </div>
          <div>
            <button
              onClick={quit}
              className="w-32 py-1 rounded-md bg-[#EA130C] font-medium"
            >
              Quit
            </button>
          </div>
